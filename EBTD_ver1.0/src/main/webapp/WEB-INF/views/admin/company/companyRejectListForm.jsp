...
<script type="text/javascript">
	...
	for(i in baList){
		...
		all += '<td><a href=/admin/company/getCompanyRejectDetail?ap_b_no='+baList[i]["ap_b_no"]+' style="text-decoration: none;">';
	...
	function fnCtg(){
		...
		for(i in baList){//2021-08-11
			...
			if( ( cur_date >= ba_date && ba_date >= period ) || val2 == 1 ){
				...
				c_name += '<td><a href=/admin/company/getCompanyRejectDetail?ap_b_no='+baList[i]["ap_b_no"]+' style="text-decoration: none;">';
