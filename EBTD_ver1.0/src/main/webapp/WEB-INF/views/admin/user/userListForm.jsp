...
<body>
	...
	<script type="text/javascript">
		...
		$('#selectSortDetail').click(function selectFortDetail(){
			...
			$.ajax({
				url: '', //필수입력값
				type: 'Get',
				data: inputUserName, //인풋박스에 입력된 값?
				dataType: 'json', //통신 결과로 넘어올 데이터 종류
				success: function(){ //통신 성공시 호출해야하는 함수 지정
					
				},
				fail: function(){	//통신 실패시
					
				},
				complete: function(){ //통신 성공 여부와 관계없이 통신이 끝난 후 호출해야하는 함수
