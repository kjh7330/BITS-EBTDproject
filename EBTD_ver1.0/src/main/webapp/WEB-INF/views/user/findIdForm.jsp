	...
	<section class="main">
		<div class="mainview">
				<table class="formtable">
				    <tr>
                        <td colspan="2"><p class="title1">ID 찾기</p></td>
                    </tr>
					<tr>
...
/* $('#u_disabledno').blur(function(){
	...
	console.log(name+phone+disno);
		
		$.ajax({
			url : '/user/findId?u_name='+name+"&u_userphonenum="+phone+"&u_disabledno="+disno,
			type : 'get',
			
			 success : function(data) {
				console.log(data);
			 	if(data!=""){
					$("#resultDiv").text("아이디 : "+data);
