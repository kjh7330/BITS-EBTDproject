...
//	//버스노선 변경 승인하기
	...
	//승인 상세 내역 가져오기
	public ModelAndView getCompanyApprovalDetail(String ap_b_no) throws JsonProcessingException {
		mav = new ModelAndView();
		ObjectMapper om = new ObjectMapper();
		String view = null;
		List<ApplyBusHistory> aList = null;
		aList = cDao.getCompanyApprovalDetail(ap_b_no);
	...
	//반려 상세 내역 가져오기
	public ModelAndView getCompanyRejectDetail(String ap_b_no) throws JsonProcessingException {
		mav = new ModelAndView();
		ObjectMapper om = new ObjectMapper();
		String view = null;
		List<ApplyBusHistory> rList = null;
		rList = cDao.getCompanyRejectDetail(ap_b_no);
